        ...
        if (!this.props.lastMessage) return (
            <Fragment>
                <div className="recent-contact__mid">
                    <div className="recent-contact__mid__title">{(this.props.partner && this.props.partner.fullname) || this.props.users.filter(username => username !== this.props.thisUser.username).join(', ')}</div>
        ...
        return (
            <div className={className} onClick={() => this.props.setActiveContact(this.props.roomId)} >
                <div className="recent-contact__left">
                    <img src={(this.props.partner && this.props.partner.avatarUrl) || '/avatars/default.png'} alt="Avatar" onError={e => {e.target.onerror = null; e.target.src='/avatars/default.png'}}/>
                </div>
